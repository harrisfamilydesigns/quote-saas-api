class Api::V1::ProjectsController < Api::V1::BaseController
  ...
  def index
    ...
    render json: projects.map { |p| ProjectSerializer.new(p).serialize }
  end
  ...
  def show
    ...
    serialized_data = ProjectSerializer.new(@project).serialize
    
    # Add material requests as a separate key in the response
    response_data = {
      project: serialized_data,
      material_requests: @project.material_requests.map { |mr| MaterialRequestSerializer.new(mr).serialize }
    }
